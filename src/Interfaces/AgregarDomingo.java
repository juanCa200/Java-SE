 ...
 * @author user
 */
public class AgregarDomingo extends javax.swing.JFrame {

    /**
     * Creates new form AgregarLunes
     */
    public AgregarDomingo() {
        initComponents();
    ...
    private void initComponents() {
        ...
        j_nivek.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
...
try{
    ...
    PreparedStatement pst = cn.prepareStatement("insert into domingos values (?,?,?,?,?)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarDomingo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AgregarDomingo().setVisible(true);
            }
        });
    }
