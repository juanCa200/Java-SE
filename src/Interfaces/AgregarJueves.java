 ...
 * @author user
 */
public class AgregarJueves extends javax.swing.JFrame {

    /**
     * Creates new form AgregarLunes
     */
    public String user_update="";
      public static String leer_niveles = "";

    public AgregarJueves() {
        initComponents();
        user_update = Jueves.user_update;
        ...
        setResizable(false);  
         ...
         try{
           ...
           PreparedStatement pst = cn.prepareStatement("select * from horario_jueves where nombre = '" + user_update + "'");
...
try{
    ...
    Connection cn = conexion.conectar();
    PreparedStatement pst = cn.prepareStatement("insert into horario_jueves values (?,?,?,?,?)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarJueves.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
