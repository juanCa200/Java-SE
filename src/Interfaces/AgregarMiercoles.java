 ...
 * @author user
 */
public class AgregarMiercoles extends javax.swing.JFrame {

    public String user_update="";
    
    public AgregarMiercoles() {
        initComponents();        
        user_update = Miercoles.user_update;
        ...
        setResizable(false);        
         ...
         try{
           ...
           PreparedStatement pst = cn.prepareStatement("select * from horario_miercoles where nombre = '" + user_update + "'");
...
try{
    ...
    Connection cn = conexion.conectar();
    PreparedStatement pst = cn.prepareStatement("insert into horario_miercoles values (?,?,?,?,?)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarMiercoles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
