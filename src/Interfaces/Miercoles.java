...
public class Miercoles extends javax.swing.JFrame {
    ...
    public Miercoles() {
        ...
        try{
            ...
            PreparedStatement pst = cn.prepareStatement("select id, nombre, fecha, descripcion, niveles from horario_miercoles");
         ...
         jTable1.addMouseListener( new MouseAdapter(){
            ...
            int columna_point = 1;
             ...
             if(fila_point  > -1){
                 ...
                 AgregarMiercoles informacion_usuario = new AgregarMiercoles();
 ...
 new AgregarMiercoles().setVisible(true);
 dispose(); 
...
try{
    ...
    Connection cn = conexion.conectar();
    PreparedStatement pst = cn.prepareStatement("select id,nombre,fecha,descripcion, niveles from horario_miercoles where id=?");
...
try{
    ...
    Connection cn = conexion.conectar();
    PreparedStatement pst = cn.prepareStatement("delete from horario_miercoles where id=?");
    pst.setString(1, convert);
    pst.executeUpdate();
    Clear_table();
    ...
    try{
        ...
        Connection cn = conexion.conectar();
        PreparedStatement pst = cn.prepareStatement("select id,nombre,fecha,descripcion,niveles from horario_miercoles where niveles = '" + variable + "'");
        ResultSet rs = pst.executeQuery();
