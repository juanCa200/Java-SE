...
public class AgregarLunes extends javax.swing.JFrame {

  
    public static String nombre, fecha, descripcion, niveles;
    public static String leer_niveles = "";
  public String user_update;
    
    public AgregarLunes() {
        initComponents();
        user_update = Lunes.user_update;
        ...
        try{
           ...
           PreparedStatement pst = cn.prepareStatement("select * from horario_lunes where nombre = '" + user_update + "'");
    ...
    private void initComponents() {
        ...
        j_nivek.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                j_nivekActionPerformed(evt);
            }
        });
...
try{
    ...
    descripcion = text_descripcion.getText().trim();
    
    
    Connection cn = conexion.conectar();
    PreparedStatement pst = cn.prepareStatement("insert into horario_lunes values (?,?,?,?,?)");
    ...
    private void j_nivekActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_j_nivekActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_j_nivekActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarLunes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
