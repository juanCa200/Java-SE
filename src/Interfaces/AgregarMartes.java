 ...
 * @author user
 */
public class AgregarMartes extends javax.swing.JFrame {

   String user_update;
   
    public AgregarMartes() {
        initComponents();
        user_update = Martes.user_update;
        ...
        try{
           ...
           PreparedStatement pst = cn.prepareStatement("select * from horario_martes where nombre = '" + user_update + "'");
...
try{
    ...
    Connection cn = conexion.conectar();
    PreparedStatement pst = cn.prepareStatement("insert into horario_martes values (?,?,?,?,?)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarMartes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
